...
export enum ProjectManagerCommands {
    CREATE_INSTALLER_PROJECT_COMMAND = 'create_installer_project_command',
    SAVE_INSTALLER_DOCUMENT_CONFIG_COMMAND = 'save_installer_document_config_command',
    ...
    OPEN_INSTALLER_PROJECT_COMMAND = 'open_installer_project_command',
